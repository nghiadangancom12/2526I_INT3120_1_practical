...
val light_theme_primary_color = Color(0xFF4355B9)
val light_theme_secondary_color = Color(0xFFFFFFFF)
val primary_container_light = Color(0xFFDEE0FF)
val light_on_primary_container_color = Color(0xFF00105C)
val light_secondary = Color(0xFF5B5D72)
val light_on_secondary_color = Color(0xFFFFFFFF)
val secondary_container_light = Color(0xFFE0E1F9)
val light_on_secondary_container_color = Color(0xFF181A2C)
val light_tertiary = Color(0xFF77536D)
val mdThemeLightOntertiary = Color(0xFFFFFFFF)
val light_tertiary_container = Color(0xFFFFD7F1)
val light_on_tertiary_container_color = Color(0xFF2D1228)
